            ...
            <div class="row">
                <section class="col-sm-4 col-lg-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="https://gcintranet.tpsgc-pwgsc.gc.ca/pm-dp/index-eng.html"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'PSPC departmental policies']);"><abbr
                                    title="Public Services and Procurement Canada">PSPC</abbr> departmental policies</a>
                        </li>
                        <li><a href="https://gcintranet.tpsgc-pwgsc.gc.ca/sc-cs/index-eng.html"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'Client service']);">Client
                                service</a></li>
                        <li><a href="https://gcintranet.tpsgc-pwgsc.gc.ca/gc/ba-ao/index-eng.html"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'PSPC Accessibility Office']);"><abbr
                                    title="Public Services and Procurement Canada">PSPC</abbr> Accessibility Office</a>
                        </li>
                    </ul>
                </section>
                <section class="col-sm-4 col-lg-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="https://www.tpsgc-pwgsc.gc.ca/comm/cn-cu-eng.html"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'Contact us']);">Contact
                                us</a></li>
                        <li><a href="https://gcdirectory-gcannuaire.ssc-spc.gc.ca/en/GCD/?pgid=014&amp;dn=OU=PSPC-SPAC,O=GC,C=CA"
                ...
                <section class="col-sm-4 col-lg-4">
                    <h3>Related sites</h3>
                    <ul class="list-unstyled">
                        <li><a href="https://www.tpsgc-pwgsc.gc.ca/comm/index-eng.html"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'PSPC Internet site']);"><abbr
                                    title="Public Services and Procurement Canada">PSPC</abbr> Internet site</a></li>
                        <li><a href="https://intranet.canada.ca/index-eng.asp"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'GCIntranet']);">GCIntranet</a>
                        </li>
                        <li><a href="https://www.canada.ca/en/services/jobs/opportunities/government.html"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'Government of Canada jobs']);">Government
                                of Canada jobs</a></li>
                        <li><a href="https://gcconnex.gc.ca/"
                                onclick="javascript:_paq.push(['trackEvent', 'Pied de page-Footer-EN', 'GCconnex']);">GCconnex</a>
                        </li>
                        <li><a href="https://www.gcpedia.gc.ca/wiki/?setlang=en"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-6 col-md-12 text-right">
                    <img src="/site/wet4.0/assets/wmms-blk.svg" alt="Symbol of the Government of Canada"/>
                </div>
            </div>
        </div>
    </div>
